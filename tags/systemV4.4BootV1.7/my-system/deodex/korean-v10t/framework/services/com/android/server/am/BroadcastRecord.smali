...
.field requiredPermission:Ljava/lang/String;
...
.field final resultTo:Landroid/content/IIntentReceiver;
...
# direct methods
.method constructor <init>(Landroid/content/Intent;Lcom/android/server/am/ProcessRecord;Ljava/lang/String;IILjava/lang/String;Ljava/util/List;Landroid/content/IIntentReceiver;ILjava/lang/String;Landroid/os/Bundle;Z)V
    .registers 14
    .parameter "_intent"
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v7, p0, Lcom/android/server/am/BroadcastRecord;->callerApp:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v7, p0, Lcom/android/server/am/BroadcastRecord;->callerPackage:Ljava/lang/String;
    ...
    iget v7, p0, Lcom/android/server/am/BroadcastRecord;->callingPid:I
    ...
    iget v7, p0, Lcom/android/server/am/BroadcastRecord;->callingUid:I
    ...
    iget-object v7, p0, Lcom/android/server/am/BroadcastRecord;->requiredPermission:Ljava/lang/String;
    ...
    iget-wide v7, p0, Lcom/android/server/am/BroadcastRecord;->startTime:J
    ...
    iget-wide v9, p0, Lcom/android/server/am/BroadcastRecord;->startTime:J
    ...
    iget v7, p0, Lcom/android/server/am/BroadcastRecord;->anrCount:I
    ...
    iget-object v7, p0, Lcom/android/server/am/BroadcastRecord;->resultTo:Landroid/content/IIntentReceiver;
    ...
    iget v7, p0, Lcom/android/server/am/BroadcastRecord;->resultCode:I
    ...
    iget-object v7, p0, Lcom/android/server/am/BroadcastRecord;->resultData:Ljava/lang/String;
    ...
    const-string v7, "resultExtras="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Lcom/android/server/am/BroadcastRecord;->resultExtras:Landroid/os/Bundle;
    ...
    const-string v7, "resultAbort="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-boolean v7, p0, Lcom/android/server/am/BroadcastRecord;->resultAbort:Z
    ...
    iget-boolean v7, p0, Lcom/android/server/am/BroadcastRecord;->ordered:Z
    ...
    iget-object v7, p0, Lcom/android/server/am/BroadcastRecord;->receiver:Landroid/os/IBinder;
    ...
    iget-object v7, p0, Lcom/android/server/am/BroadcastRecord;->curFilter:Lcom/android/server/am/BroadcastFilter;
    ...
    iget-object v7, p0, Lcom/android/server/am/BroadcastRecord;->curReceiver:Landroid/content/pm/ActivityInfo;
    ...
    iget-object v7, p0, Lcom/android/server/am/BroadcastRecord;->curApp:Lcom/android/server/am/ProcessRecord;
    ...
    .line 96
    iget-object v6, p0, Lcom/android/server/am/BroadcastRecord;->curApp:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v7, p0, Lcom/android/server/am/BroadcastRecord;->curComponent:Landroid/content/ComponentName;
    ...
    iget v6, p0, Lcom/android/server/am/BroadcastRecord;->state:I
    ...
    iget v7, p0, Lcom/android/server/am/BroadcastRecord;->state:I
    ...
    .line 112
    .local v4, printer:Landroid/util/PrintWriterPrinter;
    const/4 v1, 0x0
    ...
    .line 115
    instance-of v6, v2, Lcom/android/server/am/BroadcastFilter;
    ...
    invoke-virtual {v2, p1, v3}, Lcom/android/server/am/BroadcastFilter;->dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    .end local v4           #printer:Landroid/util/PrintWriterPrinter;
    ...
    .line 103
    .restart local v5       #stateStr:Ljava/lang/String;
    :pswitch_2e7
    ...
    .restart local v4       #printer:Landroid/util/PrintWriterPrinter;
    :cond_2fa
    ...
    .end local v2           #o:Ljava/lang/Object;
    invoke-virtual {v2, v4, v3}, Landroid/content/pm/ResolveInfo;->dump(Landroid/util/Printer;Ljava/lang/String;)V
