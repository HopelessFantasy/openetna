...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 40
    const-class v0, Ljava/nio/ShortToByteBufferAdapter;
    ...
    :goto_9
    sput-boolean v0, Ljava/nio/ShortToByteBufferAdapter;->$assertionsDisabled:Z
...
.method static wrap(Ljava/nio/ByteBuffer;)Ljava/nio/ShortBuffer;
    .registers 3
    .parameter "byteBuffer"
...
.method public addressValidityCheck()V
    ...
    .line 99
    iget-object p0, p0, Ljava/nio/ShortToByteBufferAdapter;->byteBuffer:Ljava/nio/ByteBuffer;
    ...
    .restart local p0
    :cond_e
    sget-boolean v0, Ljava/nio/ShortToByteBufferAdapter;->$assertionsDisabled:Z
...
.method public getEffectiveAddress()Lorg/apache/harmony/luni/platform/PlatformAddress;
    ...
    iput v1, p0, Ljava/nio/ShortToByteBufferAdapter;->effectiveDirectAddress:I
    ...
    .line 74
    :cond_16
    sget-boolean v1, Ljava/nio/ShortToByteBufferAdapter;->$assertionsDisabled:Z
...
.method public put([SII)Ljava/nio/ShortBuffer;
    ...
    invoke-virtual {v0, p1, p2, p3}, Ljava/nio/ReadWriteDirectByteBuffer;->put([SII)Ljava/nio/ByteBuffer;
    ...
    :cond_26
    invoke-super {p0, p1, p2, p3}, Ljava/nio/ShortBuffer;->put([SII)Ljava/nio/ShortBuffer;
...
.method public slice()Ljava/nio/ShortBuffer;
    ...
    .line 219
    .local v0, result:Ljava/nio/ShortBuffer;
    iget-object v1, p0, Ljava/nio/ShortToByteBufferAdapter;->byteBuffer:Ljava/nio/ByteBuffer;
