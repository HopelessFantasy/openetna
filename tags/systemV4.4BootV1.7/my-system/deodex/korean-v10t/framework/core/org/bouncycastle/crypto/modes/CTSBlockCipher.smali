...
.method public doFinal([BI)I
    ...
    .line 192
    iget v7, p0, Lorg/bouncycastle/crypto/modes/CTSBlockCipher;->bufOff:I
    ...
    .line 197
    :cond_f
    iget-object v7, p0, Lorg/bouncycastle/crypto/modes/CTSBlockCipher;->cipher:Lorg/bouncycastle/crypto/BlockCipher;

    invoke-interface {v7}, Lorg/bouncycastle/crypto/BlockCipher;->getBlockSize()I
    ...
    .line 201
    .local v0, block:[B
    iget-boolean v7, p0, Lorg/bouncycastle/crypto/modes/CTSBlockCipher;->forEncryption:Z
    ...
    invoke-interface {v7, v8, v10, v0, v10}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    instance-of v7, v7, Lorg/bouncycastle/crypto/modes/CBCBlockCipher;
    ...
    check-cast v7, Lorg/bouncycastle/crypto/modes/CBCBlockCipher;

    invoke-virtual {v7}, Lorg/bouncycastle/crypto/modes/CBCBlockCipher;->getUnderlyingCipher()Lorg/bouncycastle/crypto/BlockCipher;

    move-result-object v2

    .line 224
    .local v2, c:Lorg/bouncycastle/crypto/BlockCipher;
    iget-object v7, p0, Lorg/bouncycastle/crypto/modes/CTSBlockCipher;->buf:[B

    invoke-interface {v2, v7, v1, p1, p2}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I

    .line 231
    .end local v2           #c:Lorg/bouncycastle/crypto/BlockCipher;
    :goto_6b
    add-int v7, p2, v1
    ...
    invoke-interface {v7, v8, v1, p1, p2}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    .line 241
    .restart local v2       #c:Lorg/bouncycastle/crypto/BlockCipher;
    iget-object v7, p0, Lorg/bouncycastle/crypto/modes/CTSBlockCipher;->buf:[B

    invoke-interface {v2, v7, v10, v0, v10}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    iget-object v9, p0, Lorg/bouncycastle/crypto/modes/CTSBlockCipher;->buf:[B
    ...
    invoke-interface {v7, v0, v10, p1, p2}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
...
.method public processByte(B[BI)I
    ...
    invoke-interface {v1, v2, v5, p2, p3}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    iget v4, p0, Lorg/bouncycastle/crypto/modes/CTSBlockCipher;->blockSize:I
...
.method public processBytes([BII[BI)I
    ...
    invoke-interface {v4, v5, v7, p4, p5}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    invoke-interface {v4, v5, v7, p4, v6}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
