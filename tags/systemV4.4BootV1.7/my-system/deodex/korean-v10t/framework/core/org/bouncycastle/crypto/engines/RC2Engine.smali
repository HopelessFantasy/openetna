...
.method private encryptBlock([BI[BI)V
    ...
    invoke-direct {p0, v5, v6}, Lorg/bouncycastle/crypto/engines/RC2Engine;->rotateWordLeft(II)I
...
.method private generateWorkingKey([BI)[I
    ...
    .local v6, x:I
    :goto_1c
    sget-object v8, Lorg/bouncycastle/crypto/engines/RC2Engine;->piTable:[B
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    .line 125
    instance-of v3, p2, Lorg/bouncycastle/crypto/params/RC2Parameters;
    ...
    .line 129
    .local v2, param:Lorg/bouncycastle/crypto/params/RC2Parameters;
    invoke-virtual {v2}, Lorg/bouncycastle/crypto/params/RC2Parameters;->getKey()[B

    move-result-object v3

    invoke-virtual {v2}, Lorg/bouncycastle/crypto/params/RC2Parameters;->getEffectiveKeyBits()I

    move-result v4

    invoke-direct {p0, v3, v4}, Lorg/bouncycastle/crypto/engines/RC2Engine;->generateWorkingKey([BI)[I

    move-result-object v3

    iput-object v3, p0, Lorg/bouncycastle/crypto/engines/RC2Engine;->workingKey:[I

    .line 143
    .end local v2           #param:Lorg/bouncycastle/crypto/params/RC2Parameters;
    .end local p2
    :goto_18
    return-void
    ...
    .restart local p2
    :cond_19
    instance-of v3, p2, Lorg/bouncycastle/crypto/params/KeyParameter;
    ...
    invoke-direct {p0, v1, v3}, Lorg/bouncycastle/crypto/engines/RC2Engine;->generateWorkingKey([BI)[I
