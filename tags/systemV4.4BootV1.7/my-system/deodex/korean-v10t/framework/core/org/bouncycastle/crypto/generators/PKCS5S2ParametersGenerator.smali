...
.method private F([B[BI[B[BI)V
    ...
    invoke-interface {v4, v2}, Lorg/bouncycastle/crypto/Mac;->init(Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {v4, p2, v7, v5}, Lorg/bouncycastle/crypto/Mac;->update([BII)V
    ...
    invoke-interface {v4, p4, v7, v5}, Lorg/bouncycastle/crypto/Mac;->update([BII)V

    .line 51
    iget-object v4, p0, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->hMac:Lorg/bouncycastle/crypto/Mac;

    invoke-interface {v4, v3, v7}, Lorg/bouncycastle/crypto/Mac;->doFinal([BI)I
    ...
    invoke-interface {v4, v3, v7, v5}, Lorg/bouncycastle/crypto/Mac;->update([BII)V
...
.method private generateDerivedKey(I)[B
    ...
    .line 93
    invoke-direct {p0, v4, v8}, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->intToOctet([BI)V

    .line 95
    iget-object v1, p0, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->password:[B

    iget-object v2, p0, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->salt:[B

    iget v3, p0, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->iterationCount:I
...
.method public generateDerivedParameters(II)Lorg/bouncycastle/crypto/CipherParameters;
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->generateDerivedKey(I)[B
