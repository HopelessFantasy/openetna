...
.method public initializeInvalidateRegion(IIII)V
    ...
    .prologue
    .line 270
    iget-object v5, p0, Landroid/view/animation/AnimationSet;->mPreviousRegion:Landroid/graphics/RectF;

    .line 271
    .local v5, region:Landroid/graphics/RectF;
    int-to-float v7, p1
    ...
    .line 274
    iget-boolean v7, p0, Landroid/view/animation/AnimationSet;->mFillBefore:Z
    ...
    .line 277
    .local v1, animations:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/view/animation/Animation;>;"
    iget-object v6, p0, Landroid/view/animation/AnimationSet;->mTempTransformation:Landroid/view/animation/Transformation;

    .line 279
    .local v6, temp:Landroid/view/animation/Transformation;
    ...
    invoke-virtual {v0, v7, v6}, Landroid/view/animation/Animation;->applyTransformation(FLandroid/view/animation/Transformation;)V

    .line 286
    invoke-virtual {v4, v6}, Landroid/view/animation/Transformation;->compose(Landroid/view/animation/Transformation;)V
    ...
    .end local v6           #temp:Landroid/view/animation/Transformation;
    :cond_38
    return-void
.end method
