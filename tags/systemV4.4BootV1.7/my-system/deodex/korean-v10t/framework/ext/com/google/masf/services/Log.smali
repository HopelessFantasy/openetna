.class public Lcom/google/masf/services/Log;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/masf/services/Log$LogRecord;
    }
.end annotation
...
.field private static final logEntries:[Lcom/google/masf/services/Log$LogRecord;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/google/masf/services/Log;->uploadEntries:I

    new-array v0, v3, [Lcom/google/masf/services/Log$LogRecord;

    sput-object v0, Lcom/google/masf/services/Log;->logEntries:[Lcom/google/masf/services/Log$LogRecord;

    sput v1, Lcom/google/masf/services/Log;->logEntryFirst:I

    sput v1, Lcom/google/masf/services/Log;->logEntryNext:I

    sput v1, Lcom/google/masf/services/Log;->logEntryCount:I

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/google/masf/services/Log;->uploadCompleteLock:Ljava/lang/Object;

    new-instance v0, Ljava/util/Hashtable;

    invoke-direct {v0}, Ljava/util/Hashtable;-><init>()V

    sput-object v0, Lcom/google/masf/services/Log;->timers:Ljava/util/Hashtable;
    ...
    sget-object v1, Lcom/google/masf/services/Log;->logEntries:[Lcom/google/masf/services/Log$LogRecord;

    new-instance v2, Lcom/google/masf/services/Log$LogRecord;

    invoke-direct {v2}, Lcom/google/masf/services/Log$LogRecord;-><init>()V
    ...
    sput-object v0, Lcom/google/masf/services/Log;->lastExceptionString:Ljava/lang/StringBuffer;

    const-wide/16 v0, 0x0

    sput-wide v0, Lcom/google/masf/services/Log;->lastEventTimeMillis:J
...
.method public static addEvent(SLjava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {}, Lcom/google/masf/services/Log;->getPersistentStore()Lcom/google/common/io/PersistentStore;
    ...
    invoke-static {v0, v1}, Lcom/google/masf/services/Log;->resetEventLog(J)V
    ...
    sget-wide v2, Lcom/google/masf/services/Log;->lastEventTimeMillis:J
    ...
    sput-wide v0, Lcom/google/masf/services/Log;->lastEventTimeMillis:J
    :try_end_6d
    .catch Ljava/io/IOException; {:try_start_3a .. :try_end_6d} :catch_7e
    ...
    invoke-static {}, Lcom/google/masf/services/Log;->uploadEventLog()V
...
.method public static addExceptionString(Ljava/lang/String;)V
    ...
    :cond_4
    sget-object v0, Lcom/google/masf/services/Log;->lastExceptionString:Ljava/lang/StringBuffer;

    monitor-enter v0

    :try_start_7
    sget-object v1, Lcom/google/masf/services/Log;->lastExceptionString:Ljava/lang/StringBuffer;
...
.method private static addLogEntry(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget v0, Lcom/google/masf/services/Log;->logEntryCount:I
    ...
    :cond_e
    sget-object v0, Lcom/google/masf/services/Log;->logEntries:[Lcom/google/masf/services/Log$LogRecord;

    sget v1, Lcom/google/masf/services/Log;->logEntryNext:I
    ...
    iput-wide v1, v0, Lcom/google/masf/services/Log$LogRecord;->timestamp:J

    iput-object p0, v0, Lcom/google/masf/services/Log$LogRecord;->source:Ljava/lang/String;

    iput-object p1, v0, Lcom/google/masf/services/Log$LogRecord;->description:Ljava/lang/String;

    sget v0, Lcom/google/masf/services/Log;->logEntryCount:I

    add-int/lit8 v0, v0, 0x1

    sput v0, Lcom/google/masf/services/Log;->logEntryCount:I

    sget v0, Lcom/google/masf/services/Log;->logEntryNext:I

    add-int/lit8 v0, v0, 0x1

    sput v0, Lcom/google/masf/services/Log;->logEntryNext:I
...
.method public static clear()V
    ...
    :try_start_3
    invoke-static {}, Lcom/google/masf/services/Log;->clearLogEntries()V
...
.method private static clearLogEntries()V
    ...
    sput v0, Lcom/google/masf/services/Log;->logEntryFirst:I
    ...
    iput-wide v2, v1, Lcom/google/masf/services/Log$LogRecord;->timestamp:J

    iput-object v4, v1, Lcom/google/masf/services/Log$LogRecord;->source:Ljava/lang/String;

    iput-object v4, v1, Lcom/google/masf/services/Log$LogRecord;->description:Ljava/lang/String;
...
.method public static endTimer(Ljava/lang/String;)J
    ...
    sget-object v0, Lcom/google/masf/services/Log;->timers:Ljava/util/Hashtable;
    ...
    invoke-static {v0}, Lcom/google/masf/services/Log;->log(Ljava/lang/String;)V
...
.method public static endTimerAndLog(Ljava/lang/String;Ljava/lang/String;)J
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/google/masf/services/Log;->endTimerAndLogConditionally(Ljava/lang/String;Ljava/lang/String;J)J
...
.method public static endTimerAndLogConditionally(Ljava/lang/String;Ljava/lang/String;J)J
    ...
    invoke-static {p1}, Lcom/google/masf/services/Log;->endTimer(Ljava/lang/String;)J
    ...
    invoke-static {p0, v2}, Lcom/google/masf/services/Log;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static getLastExceptionString()Ljava/lang/String;
    ...
    sget-object v2, Lcom/google/masf/services/Log;->lastExceptionString:Ljava/lang/StringBuffer;
...
.method public static getLog()Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/masf/services/Log;->getLog(I)Ljava/lang/String;
...
.method public static getLog(I)Ljava/lang/String;
    ...
    sget v3, Lcom/google/masf/services/Log;->logEntryFirst:I
    ...
    :cond_21
    sget-object v3, Lcom/google/masf/services/Log;->logEntries:[Lcom/google/masf/services/Log$LogRecord;

    aget-object v3, v3, v1

    invoke-virtual {v3, v2}, Lcom/google/masf/services/Log$LogRecord;->appendToBuffer(Ljava/lang/StringBuffer;)Ljava/lang/StringBuffer;
...
.method public static getLogEntries()Ljava/util/Vector;
    ...
    sget v1, Lcom/google/masf/services/Log;->logEntryFirst:I
    ...
    :goto_a
    sget v3, Lcom/google/masf/services/Log;->logEntryCount:I
    ...
    invoke-virtual {v3}, Lcom/google/masf/services/Log$LogRecord;->toString()Ljava/lang/String;
...
.method public static log(Ljava/lang/String;)V
    ...
    invoke-static {v0, p0}, Lcom/google/masf/services/Log;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_3
    invoke-static {p0, p1}, Lcom/google/masf/services/Log;->addLogEntry(Ljava/lang/String;Ljava/lang/String;)V

    sget v1, Lcom/google/masf/services/Log;->logEntryCount:I
    ...
    invoke-static {v1}, Lcom/google/masf/services/Log;->truncateLog(I)V
...
.method public static logException(Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-static {v0}, Lcom/google/masf/services/Log;->addExceptionString(Ljava/lang/String;)V

    invoke-static {p0, p1}, Lcom/google/masf/services/Log;->logQuietException(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public static logQuietException(Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-static {p0, v0}, Lcom/google/masf/services/Log;->log(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p1}, Ljava/lang/Exception;->printStackTrace()V

    invoke-static {p0, p1}, Lcom/google/masf/services/Log;->sendException(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public static print()V
    ...
    sget-object v4, Lcom/google/masf/services/Log;->logEntries:[Lcom/google/masf/services/Log$LogRecord;
...
.method private static resetEventLog(J)V
    ...
    sput-wide p0, Lcom/google/masf/services/Log;->lastEventTimeMillis:J
    :try_end_15
...
.method public static setImmediateFlush(Z)V
    ...
    sput-boolean p0, Lcom/google/masf/services/Log;->immediateFlush:Z
...
.method public static setUploadEntries(I)V
    ...
    sput p0, Lcom/google/masf/services/Log;->uploadEntries:I
...
.method public static startTimer(Ljava/lang/String;)V
    ...
    sget-object v1, Lcom/google/masf/services/Log;->timers:Ljava/util/Hashtable;
...
.method private static takeLogEntry()Lcom/google/masf/services/Log$LogRecord;
    .registers 3
...
.method private static truncateLog(I)V
    ...
    invoke-static {}, Lcom/google/masf/services/Log;->takeLogEntry()Lcom/google/masf/services/Log$LogRecord;

    move-result-object v0

    iput-object v1, v0, Lcom/google/masf/services/Log$LogRecord;->source:Ljava/lang/String;

    iput-object v1, v0, Lcom/google/masf/services/Log$LogRecord;->description:Ljava/lang/String;
