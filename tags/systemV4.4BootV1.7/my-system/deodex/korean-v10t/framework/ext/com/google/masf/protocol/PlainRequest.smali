.class public Lcom/google/masf/protocol/PlainRequest;
...
.field payloadProvider:Lcom/google/masf/InputStreamProvider;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/google/masf/protocol/PlainRequest;->setBlockType(I)V
...
.method public constructor <init>(Ljava/lang/String;ILcom/google/masf/InputStreamProvider;)V
    ...
    invoke-direct {p0, p3}, Lcom/google/masf/protocol/PlainRequest;->setPayloadProvider(Lcom/google/masf/InputStreamProvider;)V
...
.method public constructor <init>(Ljava/lang/String;I[B)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/google/masf/protocol/PlainRequest;-><init>(Ljava/lang/String;ILcom/google/masf/InputStreamProvider;)V
...
.method private generateBlockData()V
    ...
    iget-object v0, p0, Lcom/google/masf/protocol/PlainRequest;->payloadHeader:[B

    if-nez v0, :cond_7

    invoke-direct {p0}, Lcom/google/masf/protocol/PlainRequest;->generatePayloadHeader()V
...
.method private generatePayloadHeader()V
    ...
    invoke-virtual {p0}, Lcom/google/masf/protocol/PlainRequest;->getId()I

    move-result v2

    invoke-virtual {v1, v2}, Ljava/io/DataOutputStream;->writeShort(I)V

    invoke-virtual {p0}, Lcom/google/masf/protocol/PlainRequest;->getServiceUri()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Ljava/io/DataOutputStream;->writeUTF(Ljava/lang/String;)V

    invoke-virtual {p0}, Lcom/google/masf/protocol/PlainRequest;->getServiceVersion()I

    move-result v2

    invoke-virtual {v1, v2}, Ljava/io/DataOutputStream;->writeShort(I)V

    iget-object v2, p0, Lcom/google/masf/protocol/PlainRequest;->payloadProvider:Lcom/google/masf/InputStreamProvider;
    ...
    iput-object v0, p0, Lcom/google/masf/protocol/PlainRequest;->payloadHeader:[B
...
.method private setPayloadProvider(Lcom/google/masf/InputStreamProvider;)V
    ...
    iput-object p1, p0, Lcom/google/masf/protocol/PlainRequest;->payloadProvider:Lcom/google/masf/InputStreamProvider;
...
.method protected declared-synchronized getBodyInputStream()Ljava/io/InputStream;
    ...
    :try_start_1
    invoke-direct {p0}, Lcom/google/masf/protocol/PlainRequest;->generateBlockData()V

    iget-object v0, p0, Lcom/google/masf/protocol/PlainRequest;->payloadProvider:Lcom/google/masf/InputStreamProvider;

    if-nez v0, :cond_11

    new-instance v0, Ljava/io/ByteArrayInputStream;

    iget-object v1, p0, Lcom/google/masf/protocol/PlainRequest;->payloadHeader:[B
    ...
    iget-object v2, p0, Lcom/google/masf/protocol/PlainRequest;->payloadHeader:[B
...
.method protected declared-synchronized getBodyStreamLength()I
    ...
    iget-object v1, p0, Lcom/google/masf/protocol/PlainRequest;->payloadProvider:Lcom/google/masf/InputStreamProvider;
...
.method public declared-synchronized setPayload([B)V
    ...
    iput-object v0, p0, Lcom/google/masf/protocol/PlainRequest;->payloadProvider:Lcom/google/masf/InputStreamProvider;
    :try_end_8
