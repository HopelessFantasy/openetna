...
.method public static connect(Lcom/google/common/io/HttpConnectionFactory;Ljava/lang/String;Ljava/util/Vector;[BZIII)Lcom/google/common/io/GoogleHttpConnection;
    .registers 21
    ...
    invoke-interface {p0}, Lcom/google/common/io/HttpConnectionFactory;->isNetworkAvailable()I
    ...
    :goto_18
    :try_start_18
    invoke-interface {p0, v3, v7}, Lcom/google/common/io/HttpConnectionFactory;->createConnection(Ljava/lang/String;Z)Lcom/google/common/io/GoogleHttpConnection;
    :try_end_1b
    ...
    invoke-interface {v7, v10, p1}, Lcom/google/common/io/GoogleHttpConnection;->setConnectionProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v7}, Lcom/google/common/io/GoogleHttpConnection;->openDataOutputStream()Ljava/io/DataOutputStream;
    :try_end_42
    ...
    invoke-interface {v7}, Lcom/google/common/io/GoogleHttpConnection;->isHttps()Z

    move-result v5

    if-eqz v5, :cond_7b

    invoke-interface {v7}, Lcom/google/common/io/GoogleHttpConnection;->isEndToEndSecure()Z
    ...
    :goto_6f
    invoke-static {v5}, Lcom/google/common/io/IoUtil;->closeOutputStream(Ljava/io/OutputStream;)V

    if-nez v6, :cond_77

    invoke-static {v7}, Lcom/google/common/io/IoUtil;->closeConnection(Lcom/google/common/io/GoogleHttpConnection;)V
    ...
    :cond_7b
    :try_start_7b
    invoke-interface {v7}, Lcom/google/common/io/GoogleHttpConnection;->getResponseCode()I
    :try_end_7e
    ...
    invoke-interface {v7, v4}, Lcom/google/common/io/GoogleHttpConnection;->getHeaderField(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_99
    invoke-static {p1}, Lcom/google/common/io/IoUtil;->closeOutputStream(Ljava/io/OutputStream;)V

    if-nez v6, :cond_a1

    invoke-static {p2}, Lcom/google/common/io/IoUtil;->closeConnection(Lcom/google/common/io/GoogleHttpConnection;)V
    ...
    :cond_a7
    :try_start_a7
    invoke-static {v3, v4}, Lcom/google/common/io/IoUtil;->getAbsoluteUrl(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    :try_end_aa
...
.method public static decodeURLs([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/google/common/io/IoUtil;->decodeUrl(Ljava/lang/String;)Ljava/lang/String;
...
.method public static decodeUrl(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v7, v3, v0}, Lcom/google/common/io/IoUtil;->decodeUtf8([BIIZ)Ljava/lang/String;
...
.method public static encodeMailto([Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/google/common/io/IoUtil;->encodeURLs([Ljava/lang/String;)[Ljava/lang/String;

    move-result-object v1

    const/16 v2, 0x2c

    invoke-static {v1, v2}, Lcom/google/common/util/text/TextUtil;->join([Ljava/lang/String;C)Ljava/lang/String;
    ...
    :cond_19
    invoke-static {p1}, Lcom/google/common/util/text/TextUtil;->isEmpty(Ljava/lang/String;)Z
    ...
    invoke-static {p1}, Lcom/google/common/io/IoUtil;->encodeURL(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/google/common/io/IoUtil;->appendParams(Ljava/lang/StringBuffer;Ljava/lang/String;)V

    :cond_39
    invoke-static {p2}, Lcom/google/common/util/text/TextUtil;->isEmpty(Ljava/lang/String;)Z
    ...
    invoke-static {p2}, Lcom/google/common/io/IoUtil;->encodeURL(Ljava/lang/String;)Ljava/lang/String;
...
.method public static encodeURL(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/google/common/io/IoUtil;->encodeUtf8(Ljava/lang/String;)[B
    ...
    sget-object v5, Lcom/google/common/io/IoUtil;->HEX_DIGITS:[C
...
.method public static encodeURLParameters(Ljava/util/Vector;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/common/io/IoUtil;->encodeURLParameters([[Ljava/lang/String;)Ljava/lang/String;
...
.method public static encodeURLParameters([[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/google/common/io/IoUtil;->encodeURL(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/google/common/io/IoUtil;->encodeURL(Ljava/lang/String;)Ljava/lang/String;
...
.method public static encodeUtf8(Ljava/lang/String;)[B
    ...
    invoke-static {p0, v0, v1}, Lcom/google/common/io/IoUtil;->encodeUtf8(Ljava/lang/String;[BI)I
...
.method public static getAbsoluteUrl(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/google/common/util/text/TextUtil;->isEmpty(Ljava/lang/String;)Z
...
.method public static getMailtoBody(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lcom/google/common/io/IoUtil;->getMailtoParam(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private static getMailtoParam(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/common/io/IoUtil;->decodeUrl(Ljava/lang/String;)Ljava/lang/String;
...
.method public static getMailtoTo(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/google/common/util/text/TextUtil;->split(Ljava/lang/String;C)[Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Lcom/google/common/io/IoUtil;->decodeURLs([Ljava/lang/String;)[Ljava/lang/String;
