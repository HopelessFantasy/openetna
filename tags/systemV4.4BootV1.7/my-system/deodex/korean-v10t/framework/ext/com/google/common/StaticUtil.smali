...
.method public static deleteRecordStore(Ljava/lang/String;)Z
    ...
    invoke-interface {v0, p0}, Lcom/google/common/io/PersistentStore;->deleteBlock(Ljava/lang/String;)Z
...
.method public static handleOutOfMemory()V
    ...
    :goto_c
    sget-object v0, Lcom/google/common/StaticUtil;->outOfMemoryHandlers:Ljava/util/Vector;
    ...
    check-cast v0, Lcom/google/common/OutOfMemoryHandler;

    invoke-interface {v0}, Lcom/google/common/OutOfMemoryHandler;->handleOutOfMemory()V
...
.method public static readBlockAsDataInput(Lcom/google/common/io/PersistentStore;Ljava/lang/String;)Ljava/io/DataInput;
    .registers 5

    invoke-interface {p0, p1}, Lcom/google/common/io/PersistentStore;->readBlock(Ljava/lang/String;)[B
...
.method public static readBlockAsDataInput(Ljava/lang/String;)Ljava/io/DataInput;
    ...
    invoke-static {v0, p0}, Lcom/google/common/StaticUtil;->readBlockAsDataInput(Lcom/google/common/io/PersistentStore;Ljava/lang/String;)Ljava/io/DataInput;
...
.method public static declared-synchronized readOneRecordRms(Ljava/lang/String;)[B
    ...
    const-class v0, Lcom/google/common/StaticUtil;
    ...
    invoke-interface {v1, p0}, Lcom/google/common/io/PersistentStore;->readBlock(Ljava/lang/String;)[B
    :try_end_a
...
.method public static declared-synchronized readOneRecordRmsAsDataInput(Ljava/lang/String;)Ljava/io/DataInput;
    ...
    :try_start_3
    invoke-static {p0}, Lcom/google/common/StaticUtil;->readBlockAsDataInput(Ljava/lang/String;)Ljava/io/DataInput;
    :try_end_6
...
.method public static registerOutOfMemoryHandler(Lcom/google/common/OutOfMemoryHandler;)V
    .registers 2

    sget-boolean v0, Lcom/google/common/StaticUtil;->IS_REGISTER_OUT_OF_MEMORY_HANDLER:Z
...
.method public static removeOutOfMemoryHandler(Lcom/google/common/OutOfMemoryHandler;)V
    .registers 2
...
.method public static savePreferenceAsString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/google/common/StaticUtil;->savePreferenceAsObject(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public static setPreference(Ljava/lang/String;[B)V
    ...
    invoke-interface {v0, p0, p1}, Lcom/google/common/io/PersistentStore;->setPreference(Ljava/lang/String;[B)Z
