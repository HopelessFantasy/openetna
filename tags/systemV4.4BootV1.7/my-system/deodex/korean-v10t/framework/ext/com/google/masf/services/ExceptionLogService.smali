.class public Lcom/google/masf/services/ExceptionLogService;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/google/masf/services/ExceptionLogService;->maxThrowablePerDay:I
...
.method public static log(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {p0, p1, v0}, Lcom/google/masf/services/ExceptionLogService;->log(Ljava/lang/String;Ljava/lang/Throwable;Z)V
...
.method private static log(Ljava/lang/String;Ljava/lang/Throwable;Z)V
    ...
    invoke-static {}, Lcom/google/masf/services/ExceptionLogService;->skipLog()Z
    ...
    sget-object v1, Lcom/google/masf/services/LogserviceMessageTypes;->LOG_EXCEPTION_PROTO:Lcom/google/common/io/protocol/ProtoBufType;
    ...
    invoke-virtual {v0, v1, p0}, Lcom/google/common/io/protocol/ProtoBuf;->addString(ILjava/lang/String;)V
    ...
    invoke-virtual {v1, p1}, Lcom/google/common/Config;->getStackTrace(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v2, v1}, Lcom/google/common/io/protocol/ProtoBuf;->addString(ILjava/lang/String;)V
    ...
    new-instance v2, Lcom/google/masf/services/ExceptionLogService;

    invoke-direct {v2}, Lcom/google/masf/services/ExceptionLogService;-><init>()V

    invoke-virtual {v0, v2}, Lcom/google/masf/protocol/Request;->setListener(Lcom/google/masf/protocol/Request$Listener;)V

    invoke-virtual {v1, v0, p2}, Lcom/google/masf/MobileServiceMux;->submitRequest(Lcom/google/masf/protocol/Request;Z)V
...
.method public static declared-synchronized setMaxUploadPerDay(I)V
    ...
    const-class v0, Lcom/google/masf/services/ExceptionLogService;

    monitor-enter v0

    :try_start_3
    sput p0, Lcom/google/masf/services/ExceptionLogService;->maxThrowablePerDay:I
    :try_end_5
...
.method private static declared-synchronized skipLog()Z
    ...
    :try_start_5
    sget v1, Lcom/google/masf/services/ExceptionLogService;->maxThrowablePerDay:I
    :try_end_7
    ...
    sget-wide v3, Lcom/google/masf/services/ExceptionLogService;->resetThrowableCounterTimestamp:J

    cmp-long v3, v1, v3

    if-lez v3, :cond_1e

    sput-wide v1, Lcom/google/masf/services/ExceptionLogService;->resetThrowableCounterTimestamp:J

    const/4 v1, 0x1

    sput v1, Lcom/google/masf/services/ExceptionLogService;->throwableCounter:I
    ...
    :cond_1e
    sget v1, Lcom/google/masf/services/ExceptionLogService;->throwableCounter:I

    sget v2, Lcom/google/masf/services/ExceptionLogService;->maxThrowablePerDay:I
