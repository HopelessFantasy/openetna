...
.method private generateDerivedKey()[B
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/generators/PKCS5S1ParametersGenerator;->password:[B
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/generators/PKCS5S1ParametersGenerator;->salt:[B
    ...
    invoke-interface {v2, v0, v5}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I
    ...
    invoke-interface {v2, v0, v5, v3}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
