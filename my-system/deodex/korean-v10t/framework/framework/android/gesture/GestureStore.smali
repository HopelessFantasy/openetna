...
.method public load(Ljava/io/InputStream;Z)V
    ...
    invoke-static {v1}, Landroid/gesture/GestureUtilities;->closeStream(Ljava/io/Closeable;)V
    ...
    invoke-static {v0}, Landroid/gesture/GestureUtilities;->closeStream(Ljava/io/Closeable;)V
...
.method public recognize(Landroid/gesture/Gesture;)Ljava/util/ArrayList;
    ...
    iget-object v3, v0, Landroid/gesture/Instance;->vector:[F

    invoke-virtual {v1, v2, v3}, Landroid/gesture/Learner;->classify(I[F)Ljava/util/ArrayList;
...
.method public save(Ljava/io/OutputStream;Z)V
    ...
    invoke-static {v7}, Landroid/gesture/GestureUtilities;->closeStream(Ljava/io/Closeable;)V
    ...
    invoke-static {v8}, Landroid/gesture/GestureUtilities;->closeStream(Ljava/io/Closeable;)V
