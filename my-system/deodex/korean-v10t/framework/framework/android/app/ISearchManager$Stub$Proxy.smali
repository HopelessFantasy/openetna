...
.method public getDefaultSearchableForWebSearch()Landroid/server/search/SearchableInfo;
    ...
    .line 261
    sget-object v3, Landroid/server/search/SearchableInfo;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 268
    .local v2, _result:Landroid/server/search/SearchableInfo;
    :goto_25
    ...
    .line 264
    .end local v2           #_result:Landroid/server/search/SearchableInfo;
    :cond_2c
    const/4 v2, 0x0

    .restart local v2       #_result:Landroid/server/search/SearchableInfo;
    goto :goto_25
...
.method public getSearchablesForWebSearch()Ljava/util/List;
    ...
    .line 246
    .local v2, _result:Ljava/util/List;,"Ljava/util/List<Landroid/server/search/SearchableInfo;>;"
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 246
    .end local v2           #_result:Ljava/util/List;,"Ljava/util/List<Landroid/server/search/SearchableInfo;>;"
    :catchall_24
    move-exception v3
...
.method public startSearch(Ljava/lang/String;ZLandroid/content/ComponentName;Landroid/os/Bundle;ZLandroid/app/ISearchManagerCallback;I)V
    ...
    invoke-interface {p6}, Landroid/app/ISearchManagerCallback;->asBinder()Landroid/os/IBinder;
