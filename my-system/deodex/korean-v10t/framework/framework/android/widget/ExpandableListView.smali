...
.method createContextMenuInfo(Landroid/view/View;IJ)Landroid/view/ContextMenu$ContextMenuInfo;
    ...
    .line 945
    .local v6, pm:Landroid/widget/ExpandableListConnector$PositionMetadata;
    iget-object v7, v6, Landroid/widget/ExpandableListConnector$PositionMetadata;->position:Landroid/widget/ExpandableListPosition;

    .line 946
    .local v7, pos:Landroid/widget/ExpandableListPosition;
    invoke-virtual {v6}, Landroid/widget/ExpandableListConnector$PositionMetadata;->recycle()V

    .line 948
    invoke-direct {p0, v7}, Landroid/widget/ExpandableListView;->getChildOrGroupId(Landroid/widget/ExpandableListPosition;)J

    move-result-wide p3

    .line 949
    invoke-virtual {v7}, Landroid/widget/ExpandableListPosition;->getPackedPosition()J

    move-result-wide v2

    .line 950
    .local v2, packedPosition:J
    invoke-virtual {v7}, Landroid/widget/ExpandableListPosition;->recycle()V
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    .line 306
    :goto_14f
    invoke-virtual/range {p0 .. p0}, Landroid/widget/ExpandableListView;->isCurrentRTLanguage()Z
    ...
    .line 314
    .end local v16           #leftBound:I
    .end local v19           #rightBound:I
    :cond_175
    move-object/from16 v0, v18
...
.method drawDivider(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)V
    ...
    invoke-virtual {v4, v2}, Landroid/widget/ExpandableListConnector;->getUnflattenedPos(I)Landroid/widget/ExpandableListConnector$PositionMetadata;
    ...
    iget-boolean v0, p0, Landroid/widget/ExpandableListView;->mClipChildDivider:Z
    ...
    .restart local v1       #divider:Landroid/graphics/drawable/Drawable;
...
.method public getExpandableListPosition(I)J
    ...
    invoke-virtual {v3, p1}, Landroid/widget/ExpandableListConnector;->getUnflattenedPos(I)Landroid/widget/ExpandableListConnector$PositionMetadata;
    ...
    invoke-virtual {v3}, Landroid/widget/ExpandableListPosition;->getPackedPosition()J
...
.method public getFlatListPosition(J)I
    ...
    iget v1, v2, Landroid/widget/ExpandableListPosition;->flatListPos:I
...
.method handleItemClick(Landroid/view/View;IJ)Z
    ...
    .line 524
    .local v7, posMetadata:Landroid/widget/ExpandableListConnector$PositionMetadata;
    iget-object v0, v7, Landroid/widget/ExpandableListConnector$PositionMetadata;->position:Landroid/widget/ExpandableListPosition;
    ...
    .line 530
    invoke-virtual {v7}, Landroid/widget/ExpandableListConnector$PositionMetadata;->isExpanded()Z
    ...
    invoke-virtual {v0, v7}, Landroid/widget/ExpandableListConnector;->collapseGroup(Landroid/widget/ExpandableListConnector$PositionMetadata;)Z

    .line 534
    invoke-virtual {p0, v9}, Landroid/widget/ExpandableListView;->playSoundEffect(I)V

    .line 537
    invoke-virtual {p0, v6}, Landroid/widget/ExpandableListView;->performHapticFeedback(I)Z
    ...
    iget-object v1, v7, Landroid/widget/ExpandableListConnector$PositionMetadata;->position:Landroid/widget/ExpandableListPosition;
    ...
    invoke-virtual {v0, v7}, Landroid/widget/ExpandableListConnector;->expandGroup(Landroid/widget/ExpandableListConnector$PositionMetadata;)Z
...
.method public performItemClick(Landroid/view/View;IJ)Z
    ...
    invoke-virtual {p0, p1, v2, p3, p4}, Landroid/widget/ExpandableListView;->handleItemClick(Landroid/view/View;IJ)Z
