...
.method private checkFailure()V
    ...
    iget v0, p0, Lcom/google/common/io/InMemoryPersistentStore;->nextWriteFailureCode:I
    ...
    iput v1, p0, Lcom/google/common/io/InMemoryPersistentStore;->nextWriteFailureCode:I

    new-instance v1, Lcom/google/common/io/PersistentStore$PersistentStoreException;

    const-string v2, "FORCED ERROR"

    invoke-direct {v1, v2, v0}, Lcom/google/common/io/PersistentStore$PersistentStoreException;-><init>(Ljava/lang/String;I)V
...
.method public declared-synchronized deleteAllBlocks(Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcom/google/common/io/InMemoryPersistentStore;->blocks:Ljava/util/Hashtable;
    ...
    :cond_2b
    :try_start_2b
    iput-object v2, p0, Lcom/google/common/io/InMemoryPersistentStore;->blocks:Ljava/util/Hashtable;
    :try_end_2d
...
.method public getBlockSize(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, p1}, Lcom/google/common/io/InMemoryPersistentStore;->getDataSize(Ljava/lang/String;)I
...
.method public getDataSize(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, p1}, Lcom/google/common/io/InMemoryPersistentStore;->readBlock(Ljava/lang/String;)[B
...
.method public declared-synchronized setNextFailureCode(I)V
    ...
    :try_start_1
    iput p1, p0, Lcom/google/common/io/InMemoryPersistentStore;->nextWriteFailureCode:I
    :try_end_3
...
.method public writeBlockX([BLjava/lang/String;)I
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/common/io/InMemoryPersistentStore;->writeBlock([BLjava/lang/String;)I
