...
.method private findUserSpecifiedLogClassName()Ljava/lang/String;
    ...
    invoke-virtual {p0, v3}, Lorg/apache/commons/logging/impl/LogFactoryImpl;->getAttribute(Ljava/lang/String;)Ljava/lang/Object;
    ...
    :try_end_3e
    .catch Ljava/lang/SecurityException; {:try_start_39 .. :try_end_3e} :catch_59
    ...
    invoke-static {v2}, Ljava/lang/System;->getProperty(Ljava/lang/String;)Ljava/lang/String;
    :try_end_51
    .catch Ljava/lang/SecurityException; {:try_start_4c .. :try_end_51} :catch_7c
...
.method private getBaseClassLoader()Ljava/lang/ClassLoader;
    ...
    .prologue
    const-string v5, "Bad classloader hierarchy; LogFactoryImpl was loaded via a classloader that is not related to the current context classloader."
    ...
    invoke-direct {v3, v5}, Lorg/apache/commons/logging/LogConfigurationException;-><init>(Ljava/lang/String;)V
...
.method private getConfigurationValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v3}, Lorg/apache/commons/logging/impl/LogFactoryImpl;->logDiagnostic(Ljava/lang/String;)V
    :try_end_b5
    .catch Ljava/lang/SecurityException; {:try_start_6b .. :try_end_b5} :catch_d4
...
.method private handleFlawedHierarchy(Ljava/lang/ClassLoader;Ljava/lang/Class;)V
    ...
    .prologue
    const-string v11, "You have more than one version of \'"

    const-string v10, "\' visible."

    const-string v8, "\' does not implement the Log interface."

    const-class v9, Lorg/apache/commons/logging/Log;
    ...
    :try_end_6e
    .catch Ljava/lang/Throwable; {:try_start_2c .. :try_end_6e} :catch_af
...
.method private isLogLibraryAvailable(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v2}, Lorg/apache/commons/logging/impl/LogFactoryImpl;->logDiagnostic(Ljava/lang/String;)V
    :try_end_7a
    .catch Lorg/apache/commons/logging/LogConfigurationException; {:try_start_25 .. :try_end_7a} :catch_7c
