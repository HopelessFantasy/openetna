...
.method public declared-synchronized getMaximumErrorCount()I
    ...
    :try_start_1
    iget v0, p0, Lcom/google/masf/services/resume/ResumableRequest;->maximumErrorCount:I
    :try_end_3
    .catchall {:try_start_1 .. :try_end_3} :catchall_5
...
.method public declared-synchronized getMaximumWindowSize()I
    ...
    :try_start_1
    iget v0, p0, Lcom/google/masf/services/resume/ResumableRequest;->maximumWindowSize:I
    :try_end_3
    .catchall {:try_start_1 .. :try_end_3} :catchall_5
...
.method public declared-synchronized getRequestId()Ljava/lang/String;
    ...
    :try_start_1
    iget-object v0, p0, Lcom/google/masf/services/resume/ResumableRequest;->requestId:Ljava/lang/String;
    :try_end_3
    .catchall {:try_start_1 .. :try_end_3} :catchall_5
...
.method public declared-synchronized setListener(Lcom/google/masf/services/resume/ResumableRequest$Listener;)V
    .registers 3

    monitor-enter p0

    :try_start_1
    iput-object p1, p0, Lcom/google/masf/services/resume/ResumableRequest;->listener:Lcom/google/masf/services/resume/ResumableRequest$Listener;
    :try_end_3
    .catchall {:try_start_1 .. :try_end_3} :catchall_5
...
.method public declared-synchronized setMaximumErrorCount(I)V
    ...
    :try_start_1
    iput p1, p0, Lcom/google/masf/services/resume/ResumableRequest;->maximumErrorCount:I
    :try_end_3
    .catchall {:try_start_1 .. :try_end_3} :catchall_5
...
.method public declared-synchronized setMaximumWindowSize(I)V
    ...
    :try_start_1
    iput p1, p0, Lcom/google/masf/services/resume/ResumableRequest;->maximumWindowSize:I
    :try_end_3
    .catchall {:try_start_1 .. :try_end_3} :catchall_5
...
.method public declared-synchronized setRequestId(Ljava/lang/String;)V
    ...
    :try_start_1
    iput-object p1, p0, Lcom/google/masf/services/resume/ResumableRequest;->requestId:Ljava/lang/String;
    :try_end_3
    .catchall {:try_start_1 .. :try_end_3} :catchall_5
...
.method public declared-synchronized setRequestType(I)V
    ...
    :try_start_1
    iput p1, p0, Lcom/google/masf/services/resume/ResumableRequest;->requestType:I
    :try_end_3
    .catchall {:try_start_1 .. :try_end_3} :catchall_5
