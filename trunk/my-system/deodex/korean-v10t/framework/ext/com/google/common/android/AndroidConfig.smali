...
.field protected tcpConnFactory:Lcom/google/common/io/TcpConnectionFactory;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Lcom/google/common/android/AndroidConfig;->initLocale()V
...
.method public static androidString(I)Ljava/lang/String;
    ...
    sget-object v0, Lcom/google/common/android/AndroidConfig;->stringResourceContext:Landroid/content/Context;
...
.method private getSetting(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_end_47
    .catch Ljava/lang/Throwable; {:try_start_3 .. :try_end_47} :catch_49
...
.method private initLocale()V
    ...
    invoke-virtual {v0, v1}, Lcom/google/common/I18n;->setSystemLocale(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/google/common/I18n;->setUiLocale(Ljava/lang/String;)V
...
.method public getFontFactory()Lcom/google/common/graphics/FontFactory;
    .registers 2

    iget-object v0, p0, Lcom/google/common/android/AndroidConfig;->fontFactory:Lcom/google/common/graphics/FontFactory;
...
.method public bridge synthetic getImageFactory()Lcom/google/common/graphics/ImageFactory;
    .registers 2

    invoke-virtual {p0}, Lcom/google/common/android/AndroidConfig;->getImageFactory()Lcom/google/common/graphics/android/AndroidImageFactory;
...
.method public getImageFactory()Lcom/google/common/graphics/android/AndroidImageFactory;
    .registers 2

    iget-object v0, p0, Lcom/google/common/android/AndroidConfig;->imageFactory:Lcom/google/common/graphics/android/AndroidImageFactory;
...
.method public getNativeTextFieldFactory()Lcom/google/common/ui/NativeTextFieldFactory;
    .registers 3
...
.method public declared-synchronized getTcpConnectionFactory()Lcom/google/common/io/TcpConnectionFactory;
    .registers 3

    monitor-enter p0

    :try_start_1
    iget-object v0, p0, Lcom/google/common/android/AndroidConfig;->tcpConnFactory:Lcom/google/common/io/TcpConnectionFactory;

    if-nez v0, :cond_e

    new-instance v0, Lcom/google/common/io/android/AndroidTcpConnectionFactory;

    iget-object v1, p0, Lcom/google/common/android/AndroidConfig;->context:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/google/common/io/android/AndroidTcpConnectionFactory;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/common/android/AndroidConfig;->tcpConnFactory:Lcom/google/common/io/TcpConnectionFactory;
...
.method protected initPortabilityFields(Ljava/lang/String;)V
    ...
    new-instance v0, Lcom/google/common/graphics/android/AndroidImageFactory;

    iget-object v1, p0, Lcom/google/common/android/AndroidConfig;->context:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/google/common/graphics/android/AndroidImageFactory;-><init>(Landroid/content/Context;)V
...
.method public setFontFactory(Lcom/google/common/graphics/FontFactory;)V
    .registers 2

    iput-object p1, p0, Lcom/google/common/android/AndroidConfig;->fontFactory:Lcom/google/common/graphics/FontFactory;
...
.method public setStringResourceContext(Landroid/content/Context;)V
    ...
    sput-object p1, Lcom/google/common/android/AndroidConfig;->stringResourceContext:Landroid/content/Context;
