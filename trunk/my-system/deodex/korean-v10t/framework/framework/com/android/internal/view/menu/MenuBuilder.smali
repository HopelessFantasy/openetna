...
.method static constructor <clinit>()V
    ...
    :array_20
    .array-data 0x4
        0x88t 0x0t 0x3t 0x1t
        0x89t 0x0t 0x3t 0x1t
        0x0t 0x0t 0x0t 0x0t
    .end array-data
...
.method findItemWithShortcutForKey(ILandroid/view/KeyEvent;)Lcom/android/internal/view/menu/MenuItemImpl;
    ...
    .line 798
    .end local v2           #isKeyCodeMapped:Z
    :goto_18
    return-object v10

    .line 767
    .restart local v2       #isKeyCodeMapped:Z
    :cond_19
    ...
    invoke-virtual {v2, p1, p2}, Lcom/android/internal/view/menu/MenuBuilder;->findItemWithShortcutForKey(ILandroid/view/KeyEvent;)Lcom/android/internal/view/menu/MenuItemImpl;

    move-result-object v9

    .line 773
    .local v9, subMenuItem:Lcom/android/internal/view/menu/MenuItemImpl;
    if-eqz v9, :cond_3e
    ...
    .line 777
    .end local v9           #subMenuItem:Lcom/android/internal/view/menu/MenuItemImpl;
    :cond_3e
    if-eqz v6, :cond_68
    ...
    .line 788
    .end local v7           #shortcutAlphaChar:C
    :cond_68
    ...
    .line 789
    .local v8, shortcutNumericChar:C
    and-int/lit8 v10, v4, 0x5
    ...
    .line 768
    .end local v8           #shortcutNumericChar:C
    :cond_88
