...
.field public static final INTERNAL_DRM_CONTENT_URI:Landroid/net/Uri; = null
...
.method static constructor <clinit>()V
    ...
    invoke-static {v2}, Landroid/provider/MediaStore$Audio$Media;->getDrmContentUri(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    sput-object v0, Landroid/provider/MediaStore$Audio$Media;->INTERNAL_DRM_CONTENT_URI:Landroid/net/Uri;

    .line 861
    const-string v0, "external"

    invoke-static {v1}, Landroid/provider/MediaStore$Audio$Media;->getDrmContentUri(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    sput-object v0, Landroid/provider/MediaStore$Audio$Media;->EXTERNAL_DRM_CONTENT_URI:Landroid/net/Uri;
...
.method public static getDrmContentUriForPath(Ljava/lang/String;)Landroid/net/Uri;
    .registers 2
    .parameter "path"
    ...
    sget-object v0, Landroid/provider/MediaStore$Audio$Media;->EXTERNAL_DRM_CONTENT_URI:Landroid/net/Uri;

    :goto_10
    return-object v0

    :cond_11
    sget-object v0, Landroid/provider/MediaStore$Audio$Media;->INTERNAL_DRM_CONTENT_URI:Landroid/net/Uri;
