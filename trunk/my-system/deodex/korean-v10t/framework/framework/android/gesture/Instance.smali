...
.method private static spatialSampler(Landroid/gesture/Gesture;)[F
    ...
    invoke-static {p0, v0}, Landroid/gesture/GestureUtilities;->spatialSampling(Landroid/gesture/Gesture;I)[F
...
.method private static temporalSampler(ILandroid/gesture/Gesture;)[F
    ...
    invoke-static {v7, v8}, Landroid/gesture/GestureUtilities;->temporalSampling(Landroid/gesture/GestureStroke;I)[F

    move-result-object v6

    .line 93
    .local v6, pts:[F
    invoke-static {v6}, Landroid/gesture/GestureUtilities;->computeCentroid([F)[F
    ...
    invoke-static {v6, v7, v8}, Landroid/gesture/GestureUtilities;->translate([FFF)[F

    .line 108
    float-to-double v7, v0

    invoke-static {v6, v7, v8}, Landroid/gesture/GestureUtilities;->rotate([FD)[F
