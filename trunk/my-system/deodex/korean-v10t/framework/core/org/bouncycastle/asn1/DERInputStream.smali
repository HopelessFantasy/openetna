...
.method protected buildObject(I[B)Lorg/bouncycastle/asn1/DERObject;
    ...
    new-instance v9, Lorg/bouncycastle/asn1/DERConstructedSet;

    invoke-direct {v9, v8}, Lorg/bouncycastle/asn1/DERConstructedSet;-><init>(Lorg/bouncycastle/asn1/DEREncodableVector;)V
    ...
    :sswitch_53
    invoke-static {p2}, Lorg/bouncycastle/asn1/DERBoolean;->getInstance([B)Lorg/bouncycastle/asn1/DERBoolean;
    ...
    .line 151
    :sswitch_58
    new-instance v9, Lorg/bouncycastle/asn1/DERInteger;

    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DERInteger;-><init>([B)V

    goto :goto_18

    .line 153
    :sswitch_5e
    new-instance v9, Lorg/bouncycastle/asn1/DEREnumerated;

    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DEREnumerated;-><init>([B)V
    ...
    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DERObjectIdentifier;-><init>([B)V
    ...
    invoke-direct {v9, v3, v6}, Lorg/bouncycastle/asn1/DERBitString;-><init>([BI)V
    ...
    :sswitch_7b
    new-instance v9, Lorg/bouncycastle/asn1/DERUTF8String;

    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DERUTF8String;-><init>([B)V

    goto :goto_18

    .line 166
    :sswitch_81
    new-instance v9, Lorg/bouncycastle/asn1/DERPrintableString;

    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DERPrintableString;-><init>([B)V

    goto :goto_18

    .line 168
    :sswitch_87
    new-instance v9, Lorg/bouncycastle/asn1/DERIA5String;

    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DERIA5String;-><init>([B)V

    goto :goto_18

    .line 170
    :sswitch_8d
    new-instance v9, Lorg/bouncycastle/asn1/DERT61String;

    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DERT61String;-><init>([B)V

    goto :goto_18

    .line 172
    :sswitch_93
    new-instance v9, Lorg/bouncycastle/asn1/DERVisibleString;

    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DERVisibleString;-><init>([B)V

    goto :goto_18

    .line 174
    :sswitch_99
    new-instance v9, Lorg/bouncycastle/asn1/DERUniversalString;

    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DERUniversalString;-><init>([B)V

    goto/16 :goto_18

    .line 176
    :sswitch_a0
    new-instance v9, Lorg/bouncycastle/asn1/DERGeneralString;

    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DERGeneralString;-><init>([B)V
    ...
    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DERBMPString;-><init>([B)V
    ...
    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DEROctetString;-><init>([B)V

    goto/16 :goto_18

    .line 182
    :sswitch_b5
    new-instance v9, Lorg/bouncycastle/asn1/DERUTCTime;

    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DERUTCTime;-><init>([B)V
    ...
    invoke-direct {v9, p2}, Lorg/bouncycastle/asn1/DERGeneralizedTime;-><init>([B)V
    ...
    sget-object v11, Lorg/bouncycastle/asn1/DERNull;->THE_ONE:Lorg/bouncycastle/asn1/DERNull;

    invoke-direct {v9, v12, v10, v11}, Lorg/bouncycastle/asn1/DERTaggedObject;-><init>(ZILorg/bouncycastle/asn1/DEREncodable;)V
    ...
    new-instance v11, Lorg/bouncycastle/asn1/DERConstructedSequence;

    invoke-direct {v11}, Lorg/bouncycastle/asn1/DERConstructedSequence;-><init>()V
    ...
    invoke-direct {v11, p2}, Lorg/bouncycastle/asn1/DEROctetString;-><init>([B)V
    ...
    invoke-direct {v9, v10, v2}, Lorg/bouncycastle/asn1/DERTaggedObject;-><init>(ILorg/bouncycastle/asn1/DEREncodable;)V
    ...
    invoke-direct {v9, v12, v10, v7}, Lorg/bouncycastle/asn1/DERTaggedObject;-><init>(ZILorg/bouncycastle/asn1/DEREncodable;)V
    ...
    .end local v7           #seq:Lorg/bouncycastle/asn1/DERConstructedSequence;
    :cond_12c
    new-instance v9, Lorg/bouncycastle/asn1/DERUnknownTag;

    invoke-direct {v9, p1, p2}, Lorg/bouncycastle/asn1/DERUnknownTag;-><init>(I[B)V
